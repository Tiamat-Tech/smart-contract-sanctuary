...
contract ClumsySquirrelV1 is ERC721URIStorage {
    ...
    uint private NFTPrice = 50000000000000000;
    // PaymentSplitter contract address
    address private paymentSplitterAddress = 0xE9abA803d6a801fce021d0074ae71256C9F24Da4;
    ...
    {
        require(msg.value >= NFTPrice, "Please enter the correct NFT price for minting");
