...
contract CryptoMonsterLab is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public constant PRESALE_TOKEN_PRICE = 66600000000000000; // 0.0666 ETH
    ...
    function mintPresale(uint256 numberOfTokens) external payable nonReentrant{
	    ...
	    require(presaleWalletList[msg.sender] == true, "You are not on the presale whitelist or have already minted");
    ...
    function numberBAYCOwned(address _owner) external view returns (uint256) {
