...
contract TRACSerums is ERC1155Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  uint8 public constant SKIM_MILK_ID = 0;
  uint8 public constant ONE_PERCENT_MILK_ID = 1;
  ...
  uint8 public constant MAX_TX_MINT = 8;
  uint8 public constant MAX_WHITELIST_MINT = 4;
  ...
  function isValidMint(address account, bytes calldata sig) public view returns (bool) {
  ...
  function withdraw() external onlyOwner {
    ...
    payable(0xbbaAf85F87aBC8B288925D5886FBc0DCB1ae8f57).transfer(balance * 19 / 100);
    ...
    payable(0x9c0AfBE5ffD8FCeF6AF925Ee0C9c34bb658a0aB8).transfer(balance * 12 / 100);
    payable(0x1c9A0a18a47BbB622b986b805483EC2192BE75BC).transfer(balance * 10 / 100);
    payable(0x10c653653D4C0CBcDB36d6a1E0bB4b9E5c2e6a00).transfer(balance * 5  / 100);
  }
}