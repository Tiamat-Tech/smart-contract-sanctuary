...
contract WhoKilledCaptainAlex is ERC721, ERC721URIStorage, Ownable {
    ...
    uint256 private tokenPrice = 15000000000000000; //0.015 ETH
    ...
    constructor() ERC721("WhoKilledCaptainAlex", "SupaAction!") {
   ...
   function mintGiveawayClip(address to, uint256 tokenId) public onlyOwner {
        require(tokenId > nftsPublicNumber, "You need to wait for the sale to finish!");
