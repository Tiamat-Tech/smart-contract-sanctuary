...
contract OxWorksDescriptor is IOxWorksDescriptor, Ownable {
    ...
    /**
     * @notice Given a token ID and seed, construct a token URI for an official OxWorks DAO noun.
    ...
    /**
     * @notice Given a token ID and seed, construct a base64 encoded data URI for an official OxWorks DAO noun.
     */
    function dataURI(uint256 tokenId, IOxWorksSeeder.Seed memory seed) public view override returns (string memory) {
        ...
        string memory description = string(abi.encodePacked('Noun ', nounId, ' is a member of the OxWorks DAO'));
