...
contract ContractsRegistry is IContractsRegistry, AccessControlUpgradeable {
    ...
    bytes32 constant public REWARDS_GENERATOR_NAME = keccak256("REWARDS_GENERATOR");
    ...
    bytes32 constant public LIQUIDITY_REGISTRY_NAME = keccak256("LIQUIDITY_REGISTRY");
    ...
    function upgradeContract(bytes32 name, address newImplementation) external onlyAdmin {
        ...
        require(_isProxy[contractToUpgrade], "ContractsRegistry: Can't upgrade not a proxy contract");
    ...
    function addProxyContract(bytes32 name, address contractAddress) external onlyAdmin {
        ...
        TransparentUpgradeableProxy proxy = new TransparentUpgradeableProxy(
            contractAddress, address(upgrader), ""
        );
