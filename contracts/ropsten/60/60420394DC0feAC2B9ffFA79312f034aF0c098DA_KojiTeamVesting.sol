...
contract KojiTeamVesting is Ownable {
    ...
    mapping(address => uint256) private devlist;
    ...
    constructor(address _koji, address _vestingLogic) {
        ...
        devlist[address(0x018aa70957Dfd9FF84a40BE3dE6E0564E0D5A093)] = 14600000000000000000000000000;
        devlist[address(0x90147c7cCDF01356fE7217Ce421Ad0b99993423f)] = 14600000000000000000000000000;
        devlist[address(0xaC8ecCEe643A317FeAaD3E153031b27d5eadB126)] = 14600000000000000000000000000;
        devlist[address(0x9A9f244a0a1d9E3b0c0e12FFD21DBe854a068708)] = 14600000000000000000000000000;
        devlist[address(0xD7AfeBF94988bEAa196E76B0E0B852CAB22d69f1)] = 14600000000000000000000000000;
        devlist[address(0xa8f7ff7B386B9A2732716B17dd5856EA3aC72fc8)] = 6000000000000000000000000000;
        devlist[address(0x1930F96d7afF9321836E3fbCCE96b0f48daD890e)] = 89000000000000000000000000000;
    ...
    function vest(address recipient, uint256 amount) onlyOwner public {
        ...
        require(devlist[recipient] <= amount, "KojiVEST: amount is too large for this wallet");

        if (!whitelist[recipient]) {
            require(amount <= 1000000000000000000000000000, "KojiVEST: amount is too large for this wallet");
        }      
