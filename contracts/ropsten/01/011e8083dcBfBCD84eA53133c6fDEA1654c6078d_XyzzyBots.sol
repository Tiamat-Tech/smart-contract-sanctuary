...
contract XyzzyBots is ERC721Enumerable, Ownable {
    ...
    function withdraw() public payable onlyOwner {
        ...
        uint256 a1payment = balance.mul(40).div(30);
        uint256 a2payment = balance.mul(20).div(20);
        uint256 a3payment = balance.mul(15).div(15);
        uint256 a4payment = balance.mul(5).div(15);
        uint256 a5payment = balance.mul(5).div(5);
        uint256 a6payment = balance.mul(5).div(5);
        uint256 a7payment = balance.mul(5).div(5);
        uint256 a8payment = balance.mul(5).div(5);
