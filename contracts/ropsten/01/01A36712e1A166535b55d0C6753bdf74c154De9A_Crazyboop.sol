...
contract Crazyboop is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    uint public priceSale = 0.30 ether;
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI) ERC721("Crazyboop", "CBC") PaymentSplitter(_team, _teamShares) {
    ...
    **/
    ...
    function presaleMint(address _account) external payable nonReentrant {
        ...
        require(nftsPerWallet[_account] < 10, "You can only get 10 NFT on the Presale");
    ...
    **/
    function saleMint(uint256 _ammount) external payable nonReentrant {
        ...
        require(_ammount <= max_mint_allowed, "You can't mint more than 10 tokens");
    ...
    **/
    function gift(address _account) external onlyOwner {
        ...
        require(supply + 10 <= MAX_SUPPLY, "Sold out");
