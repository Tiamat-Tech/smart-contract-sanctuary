...
contract MythDivisionAllAccessToken is ERC1155, ERC1155Burnable, ERC1155Pausable, Ownable {
    ...
    /// PUBLIC MINT
    uint256 public tokenPricePublic = 1000000000000000000; // 1 ETH
    ...
    /// PRESALE MINT
    uint256 public tokenPricePresale = 500000000000000000; // 0.5 ETH
    ...
    function mint(uint256 numberOfTokens) external payable {
        ...
        _totalSupply[mintingTokenID] += numberOfTokens;
    ...
    */
    function mintReserve(uint256 id, uint256 numberOfTokens) public onlyOwner {
        ...
        _totalSupply[id] += numberOfTokens;
    }
