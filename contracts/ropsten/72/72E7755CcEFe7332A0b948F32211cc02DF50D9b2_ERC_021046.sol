...
// main contract []
contract ERC_021046 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        // extend
        ...
        // addresses
            // contracts
                ERC_021046_LIQUIDITY private _contractLiquidity;
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_021046";
            string private _symbol = "ERC021046";
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_021046: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_021046: transfer amount exceeds allowance"));
        return(true);
    }
    ...
    // setter
        function activateContract(address addressLiquidity) external onlyOwner{
            ...
            // liquidity
                ADDRESS_LIQUIDITY = addressLiquidity;
                _contractLiquidity = ERC_021046_LIQUIDITY(ADDRESS_LIQUIDITY);
                ADDRESS_UNISWAP_PAIR = _contractLiquidity.getPair();
                _contractLiquidity.activate();
        }
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_021046: approve from the zero address");
        require(spender != address(0), "ERC_021046: approve to the zero address");
