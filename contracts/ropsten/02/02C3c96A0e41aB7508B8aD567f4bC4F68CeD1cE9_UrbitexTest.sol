...
contract UrbitexTest is Context, Ownable {
    ...
    //
    function purchase(uint32 _point, bool _unbooted, uint32 _spawnCount, address _reservedBuyer)
        external
        payable
    {
    ...
    //
    function safePurchase(uint32 _point, address _reservedBuyer, bool _unbooted, uint32 _spawnCount)
        external
        payable
    {
