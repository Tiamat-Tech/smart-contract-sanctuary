...
contract AuctioneerUpgradable is ERC1271, OwnableUpgradeable, ERC165Upgradeable, IAuctioneerUpgradeable, RolesValidator {
    ...
    event UpsertAuctioneer(address indexed token, address indexed minter, address indexed auctioneer, bool active, uint96 fee, uint256 cancelValue, uint256 start, uint256 end);
    ...
    function upsert(address _token, LibAuctioneer.Auctioneer memory data) public virtual {
        ...
        emit UpsertAuctioneer(_token, data.minter, data.auctioneer, true, data.fee, data.cancelValue, data.start, data.end);
    }
    ...
    function cancel(address _token, address _auctioneer) public payable virtual {
        ...
        emit UpsertAuctioneer(_token, _msgSender(), _auctioneer, false, 0, 0, 0, 0);
    }
