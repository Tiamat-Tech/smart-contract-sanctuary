...
contract WallWolfWack is Context, IERC20, Ownable {
    ...
    string private _name = "WallWolfWack";
    string private _symbol = "WalWW";
    ...
    address public marketingWallet = 0xC8642C55AD8C8339EdcB5190dcd40A2CFDD505BA;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public immutable uniswapV2Rot = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;

    uint256 private _maxTxAmount = _tTotal / 100;
    uint256 private numTokensSellToAddToLiquidity = _tTotal / 100000000000;
