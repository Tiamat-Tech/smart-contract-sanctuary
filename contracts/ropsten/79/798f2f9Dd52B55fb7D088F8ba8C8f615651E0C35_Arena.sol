...
contract Arena is IArena, Ownable, ReentrancyGuard, IERC721Receiver, Pausable {
    ...
    ArenaInfo squidGame = ArenaInfo("Squid Game", 30, 10, 40, 80, 10);
    ArenaInfo deathmatch = ArenaInfo("Deathmatch", 80, 40, 70, 30, 10);
    ArenaInfo escapeRoom = ArenaInfo("Escape room", 20, 40, 60, 90, 10);
        ...
        returns (uint256 playerScore)
    {
        ...
        return playerScore = playerScore.div(1000000000000000000000000000000000000000000000000) + score;
    }
