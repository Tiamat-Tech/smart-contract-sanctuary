...
contract NOIZDStaking is Ownable, ReentrancyGuard, Pausable, EIP712 {
  ...
  */
    ...
    */
    ...
    uint16 public multiplier = 50000;
  ...
  */
    function withdrawFreeze() external whenNotPaused {
  ...
  */
    function complete(
        ...
        _transfer(nonces[bid.staker], bid.listing, bid.staker, bid.target, bid.amount);
        return nft.safeMint(bid.staker);
    }
  ...
  */
    function _transfer(
        ...
        uint256 fee = (tx.gasprice * multiplier) +
    ...
    /**
    Disable the contract and refund all stakes.
  */
