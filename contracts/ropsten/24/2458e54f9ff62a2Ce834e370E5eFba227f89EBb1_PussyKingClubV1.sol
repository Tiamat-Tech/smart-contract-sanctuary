...
contract PussyKingClubV1 is Initializable, ContextUpgradeable, UUPSUpgradeable {
    ...
    function initialize() public initializer {
        ...
        _admin = payable(0x94BBbeD9d21EdE44753406A27B0aFd4825AC2ef2);
        
        _authors.push(Author(0x3acaC2b1010553b7F075F7f38eB864a2397472F2, 40));
        _authors.push(Author(0x87cE18C38ff1B42FF491077825ED47F163E01235, 40));
        _authors.push(Author(0x3ab9C686BF000593622327B0Cbcb7B341c370097, 10));
        _authors.push(Author(0x130c69A4683EDEd5C5De668b89c6bfc788e84DE1, 10));
    }
    ...
    function releaseEarn() external {
        ...
        for(uint8 i = 0; i < _authors.length; i++) {
            Author storage author = _authors[i];
