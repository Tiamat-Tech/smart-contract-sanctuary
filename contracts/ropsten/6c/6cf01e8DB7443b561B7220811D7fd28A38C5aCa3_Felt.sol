...
contract Felt is ERC721, Ownable, IMintable {
    ...
    mapping(uint256 => string) feltHashes;
    ...
    {
        return (feltIds[tokenId], feltRarities[tokenId], feltHashes[tokenId]);
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory) {
        ...
        return bytes(uri).length > 0 ? string(abi.encodePacked(uri, feltHashes[tokenId])) : "";
    }
