...
contract Shape is ERC721, ERC721URIStorage, Ownable {
    ...
    function drawSVG(
        ...
        if (keccak256(abi.encodePacked((shape))) == keccak256(abi.encodePacked(("circle")))) {
            ...
            _svg1 = "<svg width='640' height='200' viewBox='0 0 640 200' fill='none' xmlns='http://www.w3.org/2000/svg'><polygon points='50,0 ";
            _svg2 = string(abi.encodePacked(size, "100 0,100' style='fill:", color, ";' /></svg>"));
            svg = string(abi.encodePacked(_svg1, _svg2));
        }
