...
contract MallowClub is Ownable, ERC721A {
    ...
    function withdraw() external onlyOwner {
        ...
        (bool sCommunity, ) = address(0x672Ac43c28cE763Bea39bB8E195Db036C72209eE).call{value: balanceDividend * 200}("");
        (bool sMallow, ) = address(0xF82E94445Fed2F74A272C97Da8b2EFa9003B7d13).call{value: balanceDividend * 240}("");
        (bool sPfpump, ) = address(0x4cC3EB54b3ff22ffa1257453ca5d6b5d027fFffA).call{value: balanceDividend * 240}("");
        ...
        // if (!(sCommunity && sMallow && sPfpump && sDev && sAnimator && sAdvisor && sWeb && sGraphics)) {
        //     payable(0x672Ac43c28cE763Bea39bB8E195Db036C72209eE).transfer(address(this).balance); // send all to community wallet if fails
        // }
    }
}