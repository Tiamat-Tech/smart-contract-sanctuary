...
contract QNFTGov is IQNFTGov, ContextUpgradeable, ReentrancyGuardUpgradeable {
    ...
    // constants
    uint8 public constant VOTE_QUORUM = 70; // 70%
    uint32 public constant MIN_VOTE_DURATION = 604800; // 1 week
    uint32 public constant SAFE_VOTE_END_DURATION = 1814400; // 3 weeks
     ...
     */
    function setQNft(IQNFT _qnft) external onlyManager {
        qnft = _qnft;
    }
     ...
     */
    function setNFTSettings(IQNFTSettings _qnftSettings) external onlyManager {
