...
contract StakingTokenWrapper4CRE8Proxy is ReentrancyGuardUpgradeable { 
...
contract StakingRewards4CRE8Proxy is StakingTokenWrapper4CRE8Proxy, OwnableUpgradeable { 
    ...
    uint256 public constant LOCK_DURATION = 30;

    uint256 public constant rewardsPerDay = 100 * 1000 * (10 ** 18); // 100k per day
    ...
    function initialize(
        ...
        __Ownable_init();
        StakingTokenWrapper4CRE8Proxy.initialized(_stakingToken, _name, _symbol);
