...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "[xtkn291107][ownable] caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "[xtkn291107][ownable] new owner is the zero address");
...
contract IXTKN291107Liquidity{
    function init() public{}
    function getPair() public returns(address){}
}


contract IXTKN291107Project{
    function init() public{}
...
contract IXTKN291107StakingLocked{
    function init(uint256, uint256) public{}
    function balanceOf(address) public view returns(uint256){}
}


contract IXTKN291107PreSale{
    function init(uint256, address) public{}
    function balanceOf(address) public view returns(uint256){}
}


contract IXTKN291107Lottery{
...
*/
contract XTKN291107 is Context, IERC20, Ownable, RobinHood, Native, ReentrancyGuard{
    // public properties
        // lib
        ...
        // interfaces
            ...
            IXTKN291107Liquidity private _liquidity;
            IXTKN291107Project private _project;
            IXTKN291107Staking private _staking;
            IXTKN291107StakingLocked private _staking30D;
            IXTKN291107StakingLocked private _staking90D;
            IXTKN291107StakingLocked private _staking180D;
            IXTKN291107StakingLocked private _staking365D;
            IXTKN291107PreSale private _preSale;
            IXTKN291107Lottery private _lottery;
    ...
    // private properties
        ...
        // how our token is setup, standard one billion tokens, but with 9 decimals
            string private _name = "XTKN291107"; // the name of our project
            string private _symbol = "XTKN291107";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        if(!_contractLiquidityActive){
            ...
            if(ADDRESS_LIQUIDITY.balance > 0){
                ...
                // init contract
                _liquidity = IXTKN291107Liquidity(ADDRESS_LIQUIDITY);
                _liquidity.init();
    ...
    function initProject(address contractAddress) public onlyOwner{
        if(!_contractProjectActive){
            ...
            // init contract
            _project = IXTKN291107Project(ADDRESS_PROJECT);
            _project.init();
    ...
    function initStaking(
        ...
        if(!_contractStakingActive){
            ...
            // init contract
            _staking = IXTKN291107Staking(ADDRESS_STAKING);
            _staking.init();
            
            _staking30D = IXTKN291107StakingLocked(ADDRESS_STAKING_DAYS30);
            _staking30D.init(1643450863, 30);

            _staking90D = IXTKN291107StakingLocked(ADDRESS_STAKING_DAYS90);
            _staking90D.init(1643450863, 90);

            _staking180D = IXTKN291107StakingLocked(ADDRESS_STAKING_DAYS180);
            _staking180D.init(1643450863, 180);

            _staking365D = IXTKN291107StakingLocked(ADDRESS_STAKING_DAYS365);
            _staking365D.init(1643450863, 365);
    ...
    function initPreSale(address contractAddress, address contractVault) public onlyOwner{
        if(!_contractPreSaleActive){
            ...
            // init contract
            _preSale = IXTKN291107PreSale(ADDRESS_PRESALE);
            _preSale.init(1643458063, ADDRESS_PRESALE_VAULT);
    ...
    function initLottery(address contractAddress) public onlyOwner{
        if(!_contractLotteryActive){
            ...
            // init contract
            _lottery = IXTKN291107Lottery(ADDRESS_LOTTERY);
            _lottery.init(1643450863);
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "[xtkn291107] approve from the zero address");
        require(spender != address(0), "[xtkn291107] approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "[xtkn291107] decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "[xtkn291107] transfer amount exceeds allowance"));
        return(true);
    }
    ...
    function price() public view returns(uint256){
        require(_contractLiquidityActive, "[xtkn291107] no liquidity, no price!");
    ...
    function _transfer(address pFrom, address pTo, uint256 pAmount) private{
        ...
        if(pFrom == ADDRESS_PAIR){
            require(SWAPPING_ENABLED, "[xtkn291107] trading disabled during presale!");
