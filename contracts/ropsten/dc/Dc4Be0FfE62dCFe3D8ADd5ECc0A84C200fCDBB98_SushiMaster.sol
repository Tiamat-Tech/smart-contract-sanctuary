...
import "./sushi-token.sol";
import "hardhat/console.sol";

// MasterChef was the master of sushi. He now governs over PICKLES. He can make Sushis and he is a fair guy.
//
...
contract SushiMaster is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 accSushiPerShare; // Accumulated PICKLEs per share, times 1e12. See below.
    }
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 sushiReward = multiplier
            ...
            .mul(pool.allocPoint)
            .div(totalAllocPoint);
        sushi.mint(devaddr, sushiReward.div(devFundDivRate));
    ...
    // Safe sushi transfer function, just in case if rounding error causes pool to not have enough PICKLEs.
    ...
    function setSushiPerBlock(uint256 _sushiPerBlock) public onlyOwner {
        require(_sushiPerBlock > 0, "!sushiPerBlock-0");
