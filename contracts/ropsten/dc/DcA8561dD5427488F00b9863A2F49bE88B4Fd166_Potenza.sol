...
contract Potenza is PotenzaPricing {
    ...
    constructor (string memory _name, string memory _symbol, address _n, address masterMint, address dao) PotenzaPricing(_name, _symbol, IN(_n), params, 66600000000000000, 99900000000000000, masterMint, dao) {
        metadataUri = "https://arweave.net/IuqQ9Den_-xej6fZfeuTkGZGgggSREfWmA_xuID6Mls/";
