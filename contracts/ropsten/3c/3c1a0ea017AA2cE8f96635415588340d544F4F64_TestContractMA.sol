...
contract TestContractMA is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_MINT_PER_WHITELIST_SALE_WALLET = 2;
    uint256 public constant MAX_MINT_PER_RAFFLE_SALE_WALLET = 2;
    uint256 public MAX_MINT_PER_PUBLIC_SALE_WALLET = 5;
    uint256 public constant PRIVATE_SALE_PRICE = 0.3 ether; 
    uint256 public constant RAFFLE_SALE_PRICE = 0.3 ether; 
    uint256 public PUBLIC_SALE_PRICE = 0.7 ether; 
    ...
    address[] private contributors = [0x4C9e280c3FB7C15f94884bFa69C65adE5275E464, 
                                        0xF8087d77e8B0A9E9598a13e420b1D7AF1217b109
                                    ];
