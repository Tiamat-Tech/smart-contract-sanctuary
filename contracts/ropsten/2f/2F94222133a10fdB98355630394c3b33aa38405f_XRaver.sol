    ...
    SingleRoyaltiesV2Impl
{
    ...
    uint256 public constant RESERVER_XRAVERS = 150;
    ...
    constructor(
        ...
        require(_maxXravers > RESERVER_XRAVERS, "XRaver: INSUFFICIENT_COUNT");
        _uri = uri;
    ...
    function mint(uint256 numberOfTokens) public payable nonReentrant {
        ...
        require(totalSupply() > RESERVER_XRAVERS, "XRaver: RESERVE_NOT_MINTED");
        require(
    ...
    function reserve() external onlyOwner {
        require(_reserveCursor < RESERVER_XRAVERS, "XRaver: FULL_RESERVE");
