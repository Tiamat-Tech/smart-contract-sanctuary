...
contract ERC20AtomicSwapper {
    ...
    function htlt(
        ...
        require(_timestamp > block.timestamp - 1800 && _timestamp < block.timestamp + 900, "Timestamp can neither be 15 minutes ahead of the current time, nor 30 minutes later");
