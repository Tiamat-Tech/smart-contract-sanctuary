...
contract LostPunks is ERC721Enumerable, Ownable {
    ...
    string private constant SVG_HEADER = '<svg id="crisp" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 24 24">';
    string private constant SVG_FOOTER = '<style>rect{width:1px;height:1px;} #crisp{shape-rendering: crispEdges;} .backdrop{width:24px;height:24px;}</style></svg>';
