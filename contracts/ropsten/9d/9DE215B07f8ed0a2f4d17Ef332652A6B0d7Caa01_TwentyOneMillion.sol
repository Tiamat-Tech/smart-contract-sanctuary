 ...
 * 
 * Set the image for your token in 61 bytes of storage space, with Solidity based 
 * support for storing and displaying IPFS CIDv1 file links.  Storing your image 
 * IPFS CIDv1 is simple: call the cidv1ToBytes view function with your Base32 
 * image link to get all the data needed to store your image record.  
 *
 * Set a URL for your token to link to for the price of the gas, retrievable with 
 * a view function by anyone.  
 *
 * Change the image and URL for your token anytime redemption is active, and update 
