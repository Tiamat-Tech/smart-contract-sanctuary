...
contract ProyectToken is ERC20, ERC20Burnable, ERC20Pausable, AccessControlEnumerable, TransactionFee {
   ...
   */
  constructor(address masterChef) ERC20('Proyect Token', 'PCM') TransactionFee() {
