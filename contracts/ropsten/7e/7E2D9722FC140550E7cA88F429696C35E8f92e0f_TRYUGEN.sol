...
** Using FTP ILO to provide up to 6.00% of ALL transactions to early funders. This service DOES NOT give tokens to funders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x0a1ec62198136A7B156ac1d6B8eb6293cAE62AA4), 1000);
        m_DidDeploy = true;
    }
...
contract TRYUGEN is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "TRYUGEN";
    string private m_Symbol = "TRYUGEN";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0x167Bd99b8521Fa91477b76c93c724454E2E500DA);
    ...
    constructor () {
        ...
        ILO.init(6000000000000000000, 6000, 1000, 80000, m_ILOPublic);
        initTax();
