...
contract Carchain is ERC721PresetMinterPauserAutoId {
    ...
    function mintAndSet(address _to, string memory _title, string memory _make, string memory _model, uint256 _year, string memory _vin, string memory _engine, string memory _colour, string memory _plate, uint256 _km) public {
        uint256 id = _tokenIdTracker.current();
        
        metadata[id].title = _title;
