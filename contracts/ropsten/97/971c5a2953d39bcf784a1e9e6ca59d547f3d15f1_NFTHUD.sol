...
contract NFTHUD is ERC721, Pausable, Ownable, ReentrancyGuard {
  ...
  address private _developerWallet = 0xC006562812F7Adf75FA0aDCE5f02C33E070e0ada;
  ...
  constructor() ERC721("NFTHUD Membership Token", "NFTHUD") {
  ...
  function withdraw() public {
    ...
    payable(_developerWallet).transfer(balance);
  }
