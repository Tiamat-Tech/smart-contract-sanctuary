    ...
    Ownable
{
    ...
    uint MAX_SUPPLY = 2048;
    uint256 PRICE = 5 * 10 ** 16; // 0.05 ETH
    uint256 DAO_DONATION = 75 * 10 ** 14; // 0.005 ETH
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string(abi.encodePacked(revealedBaseURI, Strings.toString(tokenId))) : _tokenBaseURI;
    }
    ...
    function setRevealedBaseURI(string calldata revealedBaseURI) public onlyOwner {
