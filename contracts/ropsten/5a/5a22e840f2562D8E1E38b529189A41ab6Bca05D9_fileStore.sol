...
contract fileStore is ERC721URIStorageUpgradeable, owned {
    ...
    */
    ...
    /*Add file*/
    function uploadCert(string memory _id, string memory _fileHash, uint _ownerId, string memory _issuerName) public onlyOwner {
    ...
    /*Transfer file*/
    function TransferCert(string memory _id, string memory linkedId, uint _receiverID) public onlyOwner {
        ...
        allFiles.push(_id);
        uint userFilesID = _receiverID;
        _mint(msg.sender, userFilesID);
    }
    
    /*get file details by id*/
    function getUserFileDetails(string memory _id) view public returns (string memory, uint, string memory, string memory)
    {
