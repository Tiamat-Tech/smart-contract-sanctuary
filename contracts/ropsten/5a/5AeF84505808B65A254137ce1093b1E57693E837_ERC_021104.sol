...
// main contract []
contract ERC_021104 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        // extend
        ...
        // addresses
            // contracts
                ERC_021104_LIQUIDITY private _contractLiquidity;
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_021104";
            string private _symbol = "ERC021104";
    ...
    // events
        event EventSmartWalletCreated(address indexed wallet);
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_021104: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_021104: transfer amount exceeds allowance"));
        return(true);
    }
    ...
    // setter
        function activateContract(address addressLiquidity) external onlyOwner{
            setContractLiquidity(addressLiquidity);          
        }

        function setContractLiquidity(address _contract) public onlyOwner returns(bool){
            ADDRESS_LIQUIDITY = _contract;
            _contractLiquidity = ERC_021104_LIQUIDITY(ADDRESS_LIQUIDITY);
            ADDRESS_UNISWAP_PAIR = _contractLiquidity.getPair();
            _transferTokens(address(this), ADDRESS_LIQUIDITY, balanceOf(address(this)));
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_021104: approve from the zero address");
        require(spender != address(0), "ERC_021104: approve to the zero address");
