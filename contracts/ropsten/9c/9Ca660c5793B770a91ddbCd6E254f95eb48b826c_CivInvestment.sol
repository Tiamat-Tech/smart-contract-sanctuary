...
contract CivInvestment is ICivInvestment
{
    ...
    //         TransferHelper.safeTransfer(ETH, sender, refund0);
    //     }

    //     if (amount1 < amount1ToMint) {
    //         TransferHelper.safeApprove(CIV, address(v3NftManager), 0);
    //         uint256 refund1 = amount1ToMint - amount1;
    //         TransferHelper.safeTransfer(CIV, sender, refund1);
    //     }
    // }
    ...
    function mintNewPosition(
        ...
        // (uint256 tokenId, uint128 liquidity, uint256 amount0, uint256 amount1) = v3NftManager.mint(params);
        
        // postMint(msg.sender, tokenId, liquidity, amount0, amount1, amount0ToMint, amount1ToMint);
