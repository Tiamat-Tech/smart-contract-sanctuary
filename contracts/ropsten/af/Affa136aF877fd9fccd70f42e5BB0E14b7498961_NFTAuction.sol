...
contract NFTAuction is Ownable, Pausable, NFTAuctionStorage, IERC721Receiver {
        ...
        whenNotPaused
    {
        ...
        if (
            ...
            if (collabAddress != ADDRESS_NULL) {
                collabFee = auction.highestBidPrice.mul(collabFee).div(
                    feePercentage
                );
            }
        ...
        emit AuctionFinished(_nftContract, _tokenId, auctionId, msg.sender);
    }
        ...
        whenNotPaused
    {
        ...
        emit AuctionCanceld(_nftContract, _tokenId, auctionId, msg.sender);
    }
