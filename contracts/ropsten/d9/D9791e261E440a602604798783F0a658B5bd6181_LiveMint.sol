...
{   
    ...
    function _validateApproval() public
    {
        ...
        approveGT(address(this));

        //Approves BRT For Purchasing on ArtBlocks
        approveBRT(address(this));
    }
    ...
    function approveBRT(address to) public { IERC20(_ERC20_BRT_TokenAddress).approve(to, 10000000000000000000); }
    
    function approveGT(address to) public { IERC721(_ERC721_GoldenTokenAddress).setApprovalForAll(to, true); }
