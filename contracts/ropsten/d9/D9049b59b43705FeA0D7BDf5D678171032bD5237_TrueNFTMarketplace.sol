...
contract TrueNFTMarketplace is Ownable {
  ...
  function setOffer(uint256 price, uint256 tokenId, address tokenAddress) public{
    require(_TrueNFT.ownerOf(tokenId) == msg.sender, "Only the owner of the artwork is allowed to do this");
    ...
    emit artworkAdded(address(_TrueNFT), msg.sender, price, tokenId, offerId, false);
  }
