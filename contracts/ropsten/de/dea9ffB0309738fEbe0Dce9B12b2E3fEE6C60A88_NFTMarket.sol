...
contract NFTMarket is NFTMarketStorage {
  ...
  function initialize(address _acceptedToken) public initializer {
    ...
    listingPrice = 0.0000000003 ether;
  ...
  function createMarketSale(
    ...
    require(ERC20Upgradeable(acceptedToken).transferFrom(payable(msg.sender), idToMarketItem[itemId].seller, msg.value), "Transfering the sale amount to the seller failed");
