...
// File: contracts/Street Turtle.sol
...
contract StreetTurtleGo is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Street Turtle Go", "STG") {
    setHiddenMetadataUri("ipfs://QmdkLpB6qo6bg1NxzidvYvcXtgzBuCEfsGs8CV4QeP21E6/hidden.json");
  }
