...
contract Arena is IArena, Ownable, ReentrancyGuard, IERC721Receiver, Pausable {
    ...
    ArenaInfo squidGame = ArenaInfo("Squid Game", 300, 100, 400, 800, 100);
    ArenaInfo deathmatch = ArenaInfo("Deathmatch", 800, 400, 700, 300, 100);
    ArenaInfo escapeRoom = ArenaInfo("Escape room", 200, 400, 600, 900, 100);
        ...
        returns (uint256 playerScore)
    {
        ...
        return playerScore = playerScore.div(1000000000000000000000000000000000000000000000000) + score.mul(10000);
    }
