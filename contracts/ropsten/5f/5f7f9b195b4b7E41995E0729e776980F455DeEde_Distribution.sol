...
function transferToUser( address _admin , address _userAddress,uint _amount) public onlyOwner {
   IERC20(_tokenAddress).transferFrom(_admin,_userAddress,_amount);
