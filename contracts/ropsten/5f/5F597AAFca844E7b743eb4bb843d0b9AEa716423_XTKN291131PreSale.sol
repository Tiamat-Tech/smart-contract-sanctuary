...
contract IXTKN291131PreSaleVault{
...
*/
contract XTKN291131PreSale is Context, Ownable, Native, ReentrancyGuard{
    // lib
    ...
    // instance
        ...
        IXTKN291131PreSaleVault private _vault; // interface for investor vault
    ...
    function init(uint256 pEnd, address pVault) public onlyOwner{
        ...
        _vault = IXTKN291131PreSaleVault(ADDRESS_VAULT);
    ...
    function buy(uint256 pTokens) public{
        ...
        require(!PRESALE_ENDED, "[xtkn291131][presale] has ended sorry!");
        require(PRESALE_ENABLED, "[xtkn291131][presale] not enabled yet!");
        ...
        require(allowance >= price, "[xtkn291131][presale] you have to authorize the transfer of your USDC first!");
        require(balance >= price, "[xtkn291131][presale] you do not have enough USDC!");

        // check if user can still buy the tokens
        require(_available(pTokens), "[xtkn291131][presale] no more of these pots available!");
        require(!_bought(_msgSender(), pTokens), "[xtkn291131][presale] you can only buy one of this pot, buy another pot!");
        require(_buy(_msgSender(), pTokens, price), "[xtkn291131][presale] could not buy the pot!");
