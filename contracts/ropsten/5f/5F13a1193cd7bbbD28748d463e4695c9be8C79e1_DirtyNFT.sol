...
contract DirtyNFT is ERC721 {
    ...
    function mint(address recipient, uint256 id, uint256 quantity) public returns (uint256) {

        require(msg.sender == address(0xaF65f50C9B9036c4959414305679e5f84A614bb8), "Minting not allowed outside of the farming contract");

        string memory tokenURI;
        if (id == 1) {
            tokenURI = "https://cash.dirty.finance/nft/ohdirtypack/QmfCmSGoCwFh8kGuEUPZftJdy73gc1q8LQxS9cSHaS2Wca";
        }
