...
import "./libraries/iDexFactory.sol";
import "./libraries/iDexRouter_test.sol";
import "./libraries/iDividendDistributor.sol";
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 USDC = IERC20(0xaD6D458402F60fD3Bd25163575031ACDce07538D); // Ropsten DAI);
...
contract SPayTest is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address USDC = 0xaD6D458402F60fD3Bd25163575031ACDce07538D; // Ropsten DAI
    address public WETH = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SPY";
    string constant _symbol = "SPY";
    ...
    address public autoLiquidityReceiver = 0x535c2A72AA17296c059dE302DD23F1254aba4aDA;
    address public marketingFeeReceiver = 0x535c2A72AA17296c059dE302DD23F1254aba4aDA;
