...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minHoldAmountForRewards = 25000000 * (10**9); // Must hold 250 million tokens to receive BNB rewards.
...
contract KojiEarth is IBEP20, Auth {
    ...
    uint256 private swapThreshold = _totalSupply / 1000000; // 10M
    bool inSwap;
