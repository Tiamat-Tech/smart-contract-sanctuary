...
contract SwapDant is Ownable {
    ...
    function buytDant(uint256 _amountIn, uint256 _minAmountOut) external{
        uint256 amountOut = _amountIn.mul(1e12);
        require(_minAmountOut <= amountOut, 'Error amountOut');
    ...
    function sellDant(uint256 _amountIn, uint256 _minAmountOut) external{
