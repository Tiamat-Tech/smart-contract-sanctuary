...
contract NFTMarket is NFTMarketStorage {
  ...
  function createMarketSale(
    ...
    require(IERC20Upgradeable(acceptedToken).transferFrom(payable(msg.sender), idToMarketItem[itemId].seller, price), "Transfering the sale amount to the seller failed");
