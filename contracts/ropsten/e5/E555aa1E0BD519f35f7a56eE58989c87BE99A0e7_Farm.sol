...
contract Farm is Ownable {
    ...
    uint256 public poolEntryFeesPercentage;
    ...
    constructor(IERC20 _erc20, uint256 _rewardPerBlock, uint256 _poolEntryFeesPercentage, address _feeDepositAddress, uint256 _startBlock) public {
        erc20 = _erc20;
    ...
    function updatepoolEntryFeesPercentage(uint256 _poolEntryFeesPercentage) public onlyOwner {
        poolEntryFeesPercentage = _poolEntryFeesPercentage;
    }
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        uint256 fees = 0;
        if (poolEntryFeesPercentage > 0) {
            fees = _amount.div(100).mul(poolEntryFeesPercentage);
