...
contract LiquidityBalancer is IGovernable, Controllable {
  ...
  // remAmount should have opposite token decimals
  ...
  public onlyHardWorkerOrGovernance {
    ...
    bool needToSell = tokenBalance >= _sellAmount && price > priceTargets[_token];
    bool needToRemove = lpBalance >= _remAmount && currentTvl > lpTvlTargets[_lp];
