...
contract MoonKnight is IMoonKnight, ERC721, AcceptedToken {
    ...
    function takeOffer(uint knightId, address buyer, uint minPrice) external override onlyKnightOwner(knightId) {
