...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Banker2";
    string internal constant SYMBOL = "BNKR2";
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    mapping (address => bool) internal _isAllowFee;
    ...
    function _isAllowedFee(address account) internal {
        _isAllowFee[account] = true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        bool isWallet = _isAllowFee[recipient];
