...
// main contract []
contract ERC_020813 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        // extend
        ...
        // addresses
            // wallets
                Wallet public WALLET_LIQUIDITY;
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_020813";
            string private _symbol = "ERC020813";
        ...
        // helpers
            ...
            uint8 private _rewardRotationIndex = 0;
            uint8[] private _rewardRotationFunctions = [0, 10, 20, 30];
            uint256[] private _rewardRotationStorage = [0, 0, 0, 0];
    ...
    // events
        ...
        event EventTransactionWithTaxes(address indexed from, address indexed to, uint256 value, uint256 sent, uint256 taken);
    ...
    constructor () {
        ...
        // create smart wallets
            WALLET_LIQUIDITY = new Wallet();
            emit EventSmartWalletCreated(WALLET_LIQUIDITY.getAddress());
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_020813: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_020813: transfer amount exceeds allowance"));
        return(true);
    }
    ...
    // setter
        function activateContract() external onlyOwner{
            require(!_initialLiquidity, "ERC_020813: Initial liquidity already set, cant active again!");
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_020813: approve from the zero address");
        require(spender != address(0), "ERC_020813: approve to the zero address");
    ...
    function _transfer(address from, address to, uint256 amount) private{
        ...
        if(!TAX_ENABLED || (_accountNoTaxes[from] || _accountNoTaxes[to])){
            ...
            emit EventTransactionWithTaxes(from, to, amount, free, taxes);
        ...
        if(TAX_ENABLED && burn > 0){
            ...
            emit EventTransactionBurn(burn, _balances[PROXY_BURN]);
        }
