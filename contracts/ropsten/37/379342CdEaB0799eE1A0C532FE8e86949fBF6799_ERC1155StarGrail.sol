...
contract ERC1155StarGrail is ERC1155Base {
    ...
    function mintToTrustedWallet (LibERC1155LazyMint.Mint1155Data memory data,
        address to,
        uint256 _amount) public payable virtual onlyOwner {
            _mintToTrustedWallet(data, to, _amount);
        }
