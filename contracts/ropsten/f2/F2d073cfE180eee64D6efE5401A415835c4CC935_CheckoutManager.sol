...
contract CheckoutManager {
    ...
    event BuyItems(string orderId, uint256 buyerId, address buyer, uint256[] itemIds, uint256[] amounts);
    ...
    function buyItems(string calldata orderId, uint256 buyerId, uint256[] calldata itemIds, uint256[] calldata amounts) external payable {
