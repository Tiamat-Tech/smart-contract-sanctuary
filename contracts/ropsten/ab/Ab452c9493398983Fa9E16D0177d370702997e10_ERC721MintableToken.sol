...
import "./interfaces/IERC721MintableToken.sol";

contract ERC721MintableToken is ERC721, ERC721Enumerable, IERC721MintableToken, AccessControl, Ownable {
  ...
  /**
	 ...
	 */
	uint256 public constant UID = 0x25cb6eada74e92aa04e72adf10a1ff382694c574f6c3ed31dcaab20ff387fb43;
  ...
  /**
   * @inheritdoc IERC721MintableToken
   */
  ...
  function supportsInterface(bytes4 interfaceId) public view override(ERC721, ERC721Enumerable, AccessControl) returns (bool) {
    return interfaceId == type(IERC721MintableToken).interfaceId || super.supportsInterface(interfaceId);
  }
