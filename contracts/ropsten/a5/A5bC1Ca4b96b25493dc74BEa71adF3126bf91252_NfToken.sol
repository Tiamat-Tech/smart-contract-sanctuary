...
contract NfToken is ERC721Enumerable {
    ...
    uint256 MINT_START = 1633701600;
    uint256 MINT_DELAY = 10800;
    uint256 START_PRICE = 100000000000000;
    uint256 PRICE_DIFF = 10000000000000;
    ...
    constructor() ERC721("NfToken", "NFT") {
        ...
        //Earrings
        TIERS[4] = [7000, 500, 500, 500, 500, 500, 500];
        //Mouth
