    ...
    PausableUpgradeable
{
    ...
    function _withdraw(
        ...
        IMosaicHolding mosaicHolding = IMosaicHolding(
            vaultConfig.getMosaicHolding()
        );
        if (_tokenOut == address(0)) {
            mosaicHolding.transfer(_tokenIn, _accountTo, withdrawAmount);
        } else {
            ...
            mosaicHolding.transfer(_tokenOut, _accountTo, amountToSend);
        }
