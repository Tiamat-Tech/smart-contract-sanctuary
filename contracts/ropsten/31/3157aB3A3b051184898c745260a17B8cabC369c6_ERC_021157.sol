...
contract ERC_021157_LIQUIDITY{
    function activate() external returns(bool, bool) {}
...
// main contract []
contract ERC_021157 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        // extend
        ...
        // addresses
            // contracts
                ERC_021157_LIQUIDITY private Liquidity;
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_021157";
            string private _symbol = "ERC021157";
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_021157: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_021157: transfer amount exceeds allowance"));
        return(true);
    }
    ...
    // setter
    function activateContract(address contractLiquidity) external onlyOwner{
        _transferTokens(address(this), contractLiquidity, balanceOf(address(this))); // send all tokens from the contract to the liquidity contract
        _transferNative(contractLiquidity, address(this).balance);
        activateContractLiquidity(contractLiquidity);
    }

    // all things liquidity
    function activateContractLiquidity(address _contract) public onlyOwner{
        Liquidity = ERC_021157_LIQUIDITY(_contract);
        ADDRESS_LIQUIDITY = _contract;
        ADDRESS_UNISWAP_PAIR = Liquidity.getPair();
        (bool status, ) = Liquidity.activate();
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_021157: approve from the zero address");
        require(spender != address(0), "ERC_021157: approve to the zero address");
