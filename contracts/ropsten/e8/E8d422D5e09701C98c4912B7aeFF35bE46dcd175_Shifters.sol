...
contract Shifters is ERC721Enumerable, Ownable {
    ...
    uint256 public mintPrice = 70000000000000000; // 0.07 eth
    uint256 public preSalePrice = 70000000000000000; // 0.07 eth

    uint256 public collectionSize = 10000;
    uint256 public preSaleSize = 1500;

    string public baseUrl = "https://www.shifters.io/nft/";
