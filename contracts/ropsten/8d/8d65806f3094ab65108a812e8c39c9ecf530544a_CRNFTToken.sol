...
contract CRNFTToken is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, ERC721BurnableUpgradeable, AccessControlUpgradeable {
    ...
    function safeMint(address to, string memory uri) public onlyRole(MINTER_ROLE) {
        ...
        _setTokenCreator(tokenId, msg.sender);
        _setTokenCurator(tokenId, to);
    }
    ...
    */
     ...
     * @param _creator address of the creator of the token.
     */
    function _setTokenCurator(uint256 _tokenId, address _creator) internal {
        tokenCurators[_tokenId] = _creator;
    }
