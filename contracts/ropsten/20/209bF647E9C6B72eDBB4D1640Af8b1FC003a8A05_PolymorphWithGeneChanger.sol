...
contract PolymorphWithGeneChanger is IPolymorphWithGeneChanger, Polymorph {
    ...
    constructor(string memory name, string memory symbol, string memory baseURI, address payable _daoAddress, uint256 _baseGenomeChangePrice, uint256 _polymorphPrice, uint256 totalSupply, uint256 _randomizeGenomePrice, string memory _arweaveAssetsJSON, address _polymorphV1Address) Polymorph(name, symbol, baseURI, _daoAddress, _polymorphPrice, totalSupply, _arweaveAssetsJSON, _polymorphV1Address) {
