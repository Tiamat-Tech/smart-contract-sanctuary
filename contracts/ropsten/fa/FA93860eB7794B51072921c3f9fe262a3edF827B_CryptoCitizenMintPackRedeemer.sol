...
{   
    ...
    address private immutable _BRTMULTISIG = address(0);                                                        // Bright Moments Multisig Address
    ...
    address private immutable _MintPassContractAddress = address(0);                                            // Mint Pass
    uint256 private immutable _ArtBlocksProjectID = 0;                                                          // Galactican Project ID                                                 
    uint256 private _index = 0;
    
    // Pre-Approves 500,000 BRT For Purchasing (denoted in WEI) & Transfers Contract Ownership To Multisig
    constructor() 
    { 
        // __approveBRT(500000000000000000000000); 
    ...
    function __approveBRT(uint256 amount) private onlyOwner { IERC20(_ERC20_BRT_TokenAddress).approve(_ArtBlocksMintingContractAddress, amount); }
