...
import "./vendors/libraries/FullMath.sol";
import "./vendors/libraries/Babylonian.sol";
import "./vendors/libraries/BitMath.sol";
...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'683acd22ca088240ac78932a42410b73be68792c83c655c24411b5d9337d060c' // init code hash       
            ))));
    }
