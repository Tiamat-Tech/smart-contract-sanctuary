...
contract ExampleCoin is IERC20, SafeMath, Owned {
  ...
  // Allow spender to withdraw from sender account, multiple times, up to the tokens amount.
    ...
    // return name of the token. This is not part of the standard ERC20. 
    function name() public view returns (string memory) {
        return name;
    }

    // return symbol of the token. This is not part of the standard ERC20. 
    function symbol() public view returns (string memory) {
        return symbol;
    }

    // return the decimal value of the token. This is not part of the standard ERC20.  
