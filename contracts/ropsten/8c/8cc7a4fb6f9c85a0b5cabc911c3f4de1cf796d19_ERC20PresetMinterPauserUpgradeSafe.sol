...
interface HashedTimelockERC20 {
    function newContract(address _receiver,bytes32 _hashlock,uint256 _timelock,address _tokenContract,uint256 _amount)  external returns (bytes32 contractId);
}
...
contract ERC20PresetMinterPauserUpgradeSafe is Initializable, ContextUpgradeable, AccessControlEnumerableUpgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable {
    ...
    bytes32 public constant HTLC_CONTRACT = keccak256("HTLC_CONTRACT");
    ...
    */
    ...
    function createHTLC(address _htlcContractAddress, bytes32 _secret, uint256 _timelock, uint256 _amount) public {
          _approve(_msgSender(), _htlcContractAddress, _amount);
          HashedTimelockERC20(_htlcContractAddress).newContract(msg.sender,_secret,_timelock,address(this),_amount);
    }
