...
contract CommunityCrafting {
    ...
    function payOut(uint sff, address owner) public payable {
        ...
        ERC20(0x4fa836d67aeD3b3a62C60e5FA9AcEaB7d30EddF9).transferFrom(msg.sender, address(this), values[1]);
        // Approve the router just in case
        ERC20(0x4fa836d67aeD3b3a62C60e5FA9AcEaB7d30EddF9).approve(0xf164fC0Ec4E93095b804a4795bBe1e041497b92a, values[1]);
