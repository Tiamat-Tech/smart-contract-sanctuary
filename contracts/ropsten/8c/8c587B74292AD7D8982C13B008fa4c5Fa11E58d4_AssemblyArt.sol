...
import "./interfaces/IAssemblyArtSeeder.sol";
import "./interfaces/IAssemblyArt.sol";
...
contract AssemblyArt is ERC2981, IAssemblyArt, OSContractURI, Ownable, Manageable, ERC721Enumerable {
    ...
    IAssemblyArtSeeder public assemblySeeder;
    ...
    ERC721("Assemby Art", "AART") {
        _setupRole(DEFAULT_ADMIN_ROLE, admin);
        _treasury = treasury;
        assemblySeeder = IAssemblyArtSeeder(seeder);
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        uint256 seed = assemblySeeder.dropIdToSeed(dropId);
        //shuffle metadata
