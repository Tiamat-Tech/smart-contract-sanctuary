...
contract TFA is ERC721Enumerable, Ownable{
    ...
    function withdraw() public onlyOwner {
        ...
        payable(0xC339192482F8cAB7650C76a812cFD341ae10078c).transfer(treasuryFund); // JB
        payable(0xf3DD5c7374E2589407caE33FF00e521aed31E8a9).transfer(treasuryFund); // Snow
        payable(0x7428f69d853EE1bFcf121abdDb206e8C47729b83).transfer(devFund); // Dev
    }
