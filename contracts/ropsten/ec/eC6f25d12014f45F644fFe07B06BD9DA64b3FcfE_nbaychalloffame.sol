...
contract nbaychalloffame is ERC721, Ownable {
    ...
    function mint(address receiver, string memory name, string memory imageCID, string memory description) public onlyOwner {
        ...
        idToPlayer[mintIndex] = Player(name, imageCID, description);
