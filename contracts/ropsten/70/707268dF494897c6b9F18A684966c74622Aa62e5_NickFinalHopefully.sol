...
contract NickFinalHopefully is Context, IERC20, Ownable {
    ...
    uint256 private _purchaseMarketingFee = 8;
    ...
    string private constant _name = "NickFinalHopefully";
    string private constant _symbol = "NICKHOPE";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (isSell) {
            _feeAddr1 = _sellRedistributionFee;
            _feeAddr2 = _sellMarketingFee;
        } else {
            _feeAddr1 = _purchaseRedistributionFee;
            _feeAddr2 = _purchaseMarketingFee;
        }
