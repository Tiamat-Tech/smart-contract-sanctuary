...
contract UniswapV2Factory is IUniswapV2Factory {
    ...
    function test_blockTimeStamp() external override view returns (uint) {
        return block.timestamp;
    }

    function test_TwoDays() external override pure returns (uint) {
        return 2 days;
    }

    function test_DiffDays() external override view returns (uint) {
        uint twoDaysPlus = block.timestamp + 2 days;
        return twoDaysPlus - block.timestamp;
    }
