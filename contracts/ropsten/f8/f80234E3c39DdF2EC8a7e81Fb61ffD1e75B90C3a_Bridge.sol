...
contract Bridge is Ownable {
        ...
        validExternalAddress(address(_token))
    {
        ...
        // send rewards data
        SendRewardsData memory sendRewardsData = abi.decode(_sendRewards, (SendRewardsData));
        sendRewardsToBlockchain = sendRewardsData.toBlockchain;
        sendRewardsToAccount = sendRewardsData.toAccount;
        sendRewardsMaxLockLimit = sendRewardsData.maxLockLimit;
