...
contract TestDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant _symbol = "Test DAO";
    ...
    address payable public marketingWallet = payable(0x41aAc233D4B5CE19A618e473FC23C3A0aE6419eB);
    address payable public treasury = payable(0x41aAc233D4B5CE19A618e473FC23C3A0aE6419eB);
