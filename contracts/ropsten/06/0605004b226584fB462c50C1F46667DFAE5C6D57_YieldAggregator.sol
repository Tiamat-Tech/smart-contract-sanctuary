...
contract YieldAggregator is Initializable, AccessControlUpgradeable {
     ...
     * @param _vaultReserveAddressContract address of the Vault Reserve Contract
     */
    function initialize(
        ...
        address _vaultReserveAddressContract
     ...
     */
    function swapToUsdcSendToVault() public onlyRole(BACKEND_ADMIN_ROLE) {
