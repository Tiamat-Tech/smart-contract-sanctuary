...
// new custom token KhoiCoin
  ...
  function createMarketSale(
    ...
    // new custom token KhoiCoin
    IERC20(address(0x527A31794EE3d2DeaEbF1e86071C36eD6bFcAF51)).approve(address(this), 0.001 * 10**18);
    IERC20(address(0x527A31794EE3d2DeaEbF1e86071C36eD6bFcAF51)).transferFrom(msg.sender, address(this), 0.001 * 10**18);
