...
contract ReferralPayments is ReentrancyGuard {
    ...
    SupportedToken private firstDefaultToken = SupportedToken("VESTO", 0x1fee9F94a5d28D6848ea2681e51B6c09AF80D925);
    SupportedToken private secondDefaultToken = SupportedToken("TESTO", 0xF2C1fa0B5dBa31a1757fc7c165e71b00ea40ce46);
    SupportedToken private thirdDefaultToken = SupportedToken("PESTO", 0x3bd8Cf97FB28b447b80BBBb91AB8550FDa46eF97);
    ...
    constructor() {
        ...
        _addToken(firstDefaultToken.location, firstDefaultToken.symbol);
        _addToken(secondDefaultToken.location, secondDefaultToken.symbol);
        _addToken(thirdDefaultToken.location, thirdDefaultToken.symbol);
    }
