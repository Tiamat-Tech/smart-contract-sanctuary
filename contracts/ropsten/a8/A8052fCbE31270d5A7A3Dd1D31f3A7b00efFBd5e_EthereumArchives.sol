...
contract EthereumArchives is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function mint(uint256 blockNumber) public payable nonReentrant {
    ...
    function mintSeveral(uint256[] memory blockNumbers) public nonReentrant {
