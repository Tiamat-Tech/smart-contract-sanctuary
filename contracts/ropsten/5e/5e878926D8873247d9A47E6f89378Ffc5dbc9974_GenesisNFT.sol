...
contract GenesisNFT is Ownable, ERC721, ReentrancyGuard {
    ...
    uint256 public constant PRE_SALE_LIMIT = 10;
    uint256 public constant PUBLIC_LIMIT = 20;
    uint256 public constant PRICE = 0.001 ether;
    uint256 public constant MERCH_PASS_PRICE = 0.001 ether;
    uint256 public constant META_PASS_PRICE = 0.001 ether;
    uint256 public constant UTILITY_PASS_PRICE = 0.001 ether;
    ...
    modifier onlyIfAvailable(
        ...
        require(tokenCount < MINTABLE_SUPPLY, "Collection is sold out");
