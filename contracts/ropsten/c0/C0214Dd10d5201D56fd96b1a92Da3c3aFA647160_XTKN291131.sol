...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "[xtkn291131][ownable] caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "[xtkn291131][ownable] new owner is the zero address");
...
contract IXTKN291131Liquidity{
    function init() public{}
    function getPair() public returns(address){}
}


contract IXTKN291131Project{
    function init() public{}
...
contract IXTKN291131StakingLocked{
    function init(uint256, uint256) public{}
    function balanceOf(address) public view returns(uint256){}
}


contract IXTKN291131PreSale{
    function init(uint256, address) public{}
    function balanceOf(address) public view returns(uint256){}
}


contract IXTKN291131Lottery{
...
*/
contract XTKN291131 is Context, IERC20, Ownable, RobinHood, Native, ReentrancyGuard{
    // public properties
        // lib
        ...
        // interfaces
            ...
            IXTKN291131Liquidity private _liquidity;
            IXTKN291131Project private _project;
            IXTKN291131Staking private _staking;
            IXTKN291131StakingLocked private _staking30D;
            IXTKN291131StakingLocked private _staking90D;
            IXTKN291131StakingLocked private _staking180D;
            IXTKN291131StakingLocked private _staking365D;
            IXTKN291131PreSale private _preSale;
            IXTKN291131Lottery private _lottery;
    ...
    // private properties
        ...
        // how our token is setup, standard one billion tokens, but with 9 decimals
            string private _name = "XTKN291131"; // the name of our project
            string private _symbol = "XTKN291131";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        if(!_contractLiquidityActive){
            ...
            if(ADDRESS_LIQUIDITY.balance > 0){
                ...
                // init contract
                _liquidity = IXTKN291131Liquidity(ADDRESS_LIQUIDITY);
                _liquidity.init();
    ...
    function initProject(address contractAddress) public onlyOwner{
        if(!_contractProjectActive){
            ...
            // init contract
            _project = IXTKN291131Project(ADDRESS_PROJECT);
            _project.init();
    ...
    function initStaking(
        ...
        if(!_contractStakingActive){
            ...
            // init contract
            _staking = IXTKN291131Staking(ADDRESS_STAKING);
            _staking.init();
            
            _staking30D = IXTKN291131StakingLocked(ADDRESS_STAKING_DAYS30);
            _staking30D.init(1643452306, 30);

            _staking90D = IXTKN291131StakingLocked(ADDRESS_STAKING_DAYS90);
            _staking90D.init(1643452306, 90);

            _staking180D = IXTKN291131StakingLocked(ADDRESS_STAKING_DAYS180);
            _staking180D.init(1643452306, 180);

            _staking365D = IXTKN291131StakingLocked(ADDRESS_STAKING_DAYS365);
            _staking365D.init(1643452306, 365);
    ...
    function initPreSale(address contractAddress, address contractVault) public onlyOwner{
        if(!_contractPreSaleActive){
            ...
            // init contract
            _preSale = IXTKN291131PreSale(ADDRESS_PRESALE);
            _preSale.init(1643495506, ADDRESS_PRESALE_VAULT);
    ...
    function initLottery(address contractAddress) public onlyOwner{
        if(!_contractLotteryActive){
            ...
            // init contract
            _lottery = IXTKN291131Lottery(ADDRESS_LOTTERY);
            _lottery.init(1643452306);
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "[xtkn291131] approve from the zero address");
        require(spender != address(0), "[xtkn291131] approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "[xtkn291131] decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "[xtkn291131] transfer amount exceeds allowance"));
        return(true);
    }
    ...
    function price() public view returns(uint256){
        require(_contractLiquidityActive, "[xtkn291131] no liquidity, no price!");
    ...
    function _transfer(address pFrom, address pTo, uint256 pAmount) private{
        ...
        if(pFrom == ADDRESS_PAIR){
            require(SWAPPING_ENABLED, "[xtkn291131] trading disabled during presale!");
