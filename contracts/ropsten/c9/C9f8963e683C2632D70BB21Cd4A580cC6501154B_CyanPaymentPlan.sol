...
contract CyanPaymentPlan is AccessControl, ReentrancyGuard {
    ...
    function createPaymentPlan(
        ...
        // require(
        //     paymentPlan.totalNumberOfPayments <= 4,
        ...
        // TODO(Naba): check if token exists
        ...
        onlyRole(CYAN_ROLE)
    {
        ...
        WrappedNFT _wNFTContract = WrappedNFT(wNFTContract);
        _wNFTContract.unwrap(
            wNFTTokenId,
            /* isDefaulted = */
            true
        );
