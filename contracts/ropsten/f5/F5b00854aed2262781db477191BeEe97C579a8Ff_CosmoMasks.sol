 ...
 */
contract CosmoMasks is Context, Ownable, ERC165, ICosmoMasks, IERC721Metadata {
    ...
    string public constant COSMOMASKS_PROVENANCE =
        "df760c771ad006eace0d705383b74158967e78c6e980b35f670249b5822c42e1";

    uint256 public constant SALE_START_TIMESTAMP = 1613615131;
     ...
     */
    constructor(address nctAddress_) {
        _name = "CosmoMasks";
        _symbol = "CM";
        _nctAddress = nctAddress_;
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 16381) {
            return 1000000000000000000000; // 16381 - 16383 1000 ETH
        } else if (currentSupply >= 16000) {
            return 30000000000000000000; // 16000 - 16380 30 ETH
        } else if (currentSupply >= 15000) {
            return 17000000000000000000; // 15000  - 15999 17 ETH
        } else if (currentSupply >= 11000) {
            return 9000000000000000000; // 11000 - 14999 9 ETH
        } else if (currentSupply >= 7000) {
            return 5000000000000000000; // 7000 - 10999 5 ETH
        } else if (currentSupply >= 3000) {
            return 3000000000000000000; // 3000 - 6999 3 ETH
        } else {
            return 1000000000000000000; // 0 - 2999 1 ETH
        }
    }
    ...
    function changeName(uint256 tokenId, string memory newName) public {
        ...
        IERC20Burnable(_nctAddress).burn(NAME_CHANGE_PRICE);
