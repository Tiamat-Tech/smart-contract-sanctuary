...
contract LdmMultiTrade {
    ...
    // function _uniswapTradeETH(uint256 amountIn, uint256 amountOutMin,uint256 deadline) private {
    //     address[] memory path =  new address[](2);
    //     path[0] = INJ;
    //     path[1] = 0xc778417E063141139Fce010982780140Aa0cD5Ab;

    //     address recipient = msg.sender;
    //     uniswapRouter.swapExactTokensForETH(amountIn, amountOutMin,path, recipient, deadline);
    // }
