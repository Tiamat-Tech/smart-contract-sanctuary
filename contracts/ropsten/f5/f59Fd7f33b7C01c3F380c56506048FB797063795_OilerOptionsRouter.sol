...
contract OilerOptionsRouter is IOilerOptionsRouter {
    ...
    function writeAndAddLiquidity(
        ...
        // CUONG: from what I read, this contract should be approved an allowance of 
        // _liquidityProviderCollateralAmount of collateralInstance of the options
    ...
    /// @dev 2. router receives writer rights
    // CUONG: why router receives the writer rights, it should be the msg.sender who receives the writer rights
