...
contract BunnyMembership is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl {
    ...
    */
    ...
    function configureMembership( uint _mType, uint _mSupply, uint _mReserved, uint _mPrice ) public onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        //_discountTable[_memebershipPrice[_mType]][0] = _mPrice;                // Full price
        //_discountTable[_memebershipPrice[_mType]][1] = (_mPrice/4) * 3;        // 25% off
        //_discountTable[_memebershipPrice[_mType]][2] = _mPrice/2;              // 50% off
        //_discountTable[_memebershipPrice[_mType]][3] = _mPrice/4;              // 75% off
        //_discountTable[_memebershipPrice[_mType]][4] = 0;                      // FREE
    }
