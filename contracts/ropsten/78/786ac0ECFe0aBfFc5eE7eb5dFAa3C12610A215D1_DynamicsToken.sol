...
//                skipBB = true;
//                shouldSwap = true;
                if(automatedReflectionsEnabled && !routerInvolved)
                    reflectRewards();
            }
...
//        maxNumTokensSellToAddToLiquidity = maxSwapNumber * 10 ** decimals;
    ...
    function setSwapsEnabled(bool _buybackEnabled, bool _ethSwapEnabled, uint256 maxFractionOfPoolToSell) public onlyOwner {
