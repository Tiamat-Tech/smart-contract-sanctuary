...
contract ClaimingRegistry is IClaimingRegistry, Initializable, AbstractDependant {
    ...
    uint256 internal constant ANONYMOUS_VOTING_DURATION_CONTRACT = 300; // 1 weeks
    uint256 internal constant ANONYMOUS_VOTING_DURATION_EXCHANGE = 600; // 30 days
    
    uint256 internal constant EXPOSE_VOTE_DURATION = 300; // 1 weeks
    uint256 internal constant PRIVATE_CLAIM_DURATION = 300; // 3 days
