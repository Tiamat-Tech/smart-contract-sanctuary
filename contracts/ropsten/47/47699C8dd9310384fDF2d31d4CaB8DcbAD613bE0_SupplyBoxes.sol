    ...
    ControlledAccess
{
    ...
    **/
    ...
    // Increase this like a nonce upon whitelist update.
    uint256 public currentWhitelistId = 1;
    ...
    function setCurrentWhitelistId(uint256 _whitelistId) public onlyOwner {
        currentWhitelistId = _whitelistId;
    }
    ...
    function whitelistMint(
        ...
        require(
            !privateMintClaimed[currentWhitelistId][tokenId][msg.sender],
            "Already claimed!"
        );

        // Let's mint!
        privateMintClaimed[currentWhitelistId][tokenId][msg.sender] = true;
