...
contract Rug is ERC721Enumerable, ERC721URIStorage, Ownable, Pausable {
    ...
    uint256 public constant tokenPrice = 0.04224 ether;
    ...
    function rugPull(string calldata _uri) public whenNotPaused payable {
        uint256 newItemId = _tokenIds.current();
        _tokenIds.increment();

        require(newItemId <= maxSupply, "Mint amount exceeds the max supply");
