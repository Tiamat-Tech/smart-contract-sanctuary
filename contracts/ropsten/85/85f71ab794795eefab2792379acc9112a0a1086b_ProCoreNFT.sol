...
contract ProCoreNFT is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public MAX_MINTS_PER_TXN = 11;
    ...
    constructor() public ERC721("ProCoreNFT", "PCNFT") {
        ...
        _shareholders[1] = 0xc816E96873fCa8f5586699CbBe06f8312Bd7eF39;
        _shareholders[2] = 0x0242352565711BFe370Fc6e76ec78C1c2CED34A4;
        ...
        public payable
    {
        ...
        require(TOKEN_COUNTER + numberOfTokens <= maxTokenSupply, "Purchase would exceed max available planets");
