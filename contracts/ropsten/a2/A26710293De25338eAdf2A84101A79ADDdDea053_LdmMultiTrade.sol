...
contract LdmMultiTrade {
    ...
    function tradeSushi(uint256 amountIn,address tokenIn,address tokenOut) public {
    ...
    function tradeSushiEth(uint256 amountIn,address tokenIn,address tokenOut) public {
        uint256 amountOutMin = 1;
        uint256 deadline = block.timestamp + 300;
        address[] memory path =  new address[](2);
        path[0] = tokenIn;
