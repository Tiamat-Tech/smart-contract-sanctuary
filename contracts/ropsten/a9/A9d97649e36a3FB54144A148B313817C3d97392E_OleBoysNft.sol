    ...
    function mintNFT(
      ...
      //  uint256 newItemId = _tokenIds.current();
        ...
        if (_isAllowedToMintTokenId > 0){
            _setTokenURI(_isAllowedToMintTokenId, setTokenURIMetadata(_isAllowedToMintTokenId));//"https://ipfs.io/ipfs/QmUF8XAS52tfYoePHhiraBS7hkEQpnigizN6LebL4bvPYY/coin" & _isAllowedToMintTokenId & ".png");
            _mint(msg.sender, _isAllowedToMintTokenId);
        }
        
    }

    function setTokenURIMetadata(uint256 _tokenId) public pure returns (string memory _tokenURI) {
        
        _tokenURI = "https://ipfs.io/ipfs/QmUF8XAS52tfYoePHhiraBS7hkEQpnigizN6LebL4bvPYY/coin1.json"; /// & _tokenId & ".png";
        return _tokenURI;
    }
