...
contract Stablecoin is ERC20, AccessControl, Pausable {
    ...
    // Restrict access to other Inherited methods
    function allowance() public pure {revert("disabled"); }
    function increaseAllowance() public pure{ revert("disabled"); }
    function decreaseAllowance() public pure { revert("disabled"); }
    function transferFrom() public pure { revert("disabled"); }
