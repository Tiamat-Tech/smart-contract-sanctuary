...
contract BLXMRouter is BLXMRewardProvider, IBLXMRouter {
    ...
    function addLiquidity(
        ...
        address treasury = IBLXMTreasuryManager(TREASURY_MANAGER).getTreasury(tokenA, tokenB);
    ...
    function addLiquidityETH(
        ...
        address treasury = IBLXMTreasuryManager(TREASURY_MANAGER).getTreasury(token, WETH);
    ...
    function removeLiquidity(
        ...
        require (IBLXMTreasuryManager(TREASURY_MANAGER).getTreasury(tokenA, tokenB) != address(0), 'TREASURY_NOT_FOUND');
        uint amount0;
        uint amount1;
