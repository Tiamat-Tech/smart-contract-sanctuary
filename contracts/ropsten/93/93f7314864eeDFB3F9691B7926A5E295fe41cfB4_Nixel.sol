...
contract Nixel is ERC721Enumerable, Ownable {
    ...
    function setStakingAddress(address payable _stakingContractAddress) public virtual onlyOwner {
    ...
    function setForSale(
        ...
        require(_isForSale ? _forSale[x_pos][y_pos] == false : _forSale[x_pos][y_pos], "NFT is already for sale");
    ...
    function setForRent(
        ...
        require(_isForRent ? _forRent[x_pos][y_pos] == false : _forRent[x_pos][y_pos] == true, "NFT is already for rent");
