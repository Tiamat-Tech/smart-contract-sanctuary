...
contract SatoshiART1155 is ERC1155, AccessControl {
  ...
  constructor() ERC1155("www.satoshi.art/api/public/tokens/{id}") {
  ...
  function burnToken(uint256 id, uint256 amount) external returns (bool) {
    require(balanceOf(msg.sender, id) >= 1, "user is not an owner");
