...
interface ERC721Metadata
{
  ...
  /**
   * @dev Returns a nftype for a collection of NFTs in this contract.
   * @return _nftype Representing symbol.
   */
  function nftype()
    external
    view
  ...
  /**
   * @dev Returns description for a collection of NFTs in this contract.
   * @return _desc Representing symbol.
   */
  function description()
    external
    view
    returns (string memory _desc);
    
  /**
   * @dev Returns price in ETH for a collection of NFTs in this contract.
   * @return _price Representing symbol.
   */
  function price()
    external
    view
