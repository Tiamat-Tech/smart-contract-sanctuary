...
contract Maze is Ownable, Pausable, IERC721Receiver {
    ...
    event AuctionCreated(address contractAddress, uint256 tokenId);

    // auction successful event
    event AuctionSuccessful(address contractAddress, uint256 tokenId, uint256 price, address winner);
    ...
    function setContractAuctionParam(
    ...
    function getContractAuctionParam(address _contractAddress)
        external
        view
        returns (
            uint8 auctionType,
    ...
    function _createAuction(
        ...
        emit AuctionCreated(_contractAddress, _tokenId);
    }
