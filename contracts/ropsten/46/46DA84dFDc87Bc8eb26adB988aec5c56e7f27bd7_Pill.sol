...
contract Pill is IBEP20, Auth, IERC721Receiver {
    ...
    function setPoolAddress(address _poolAddress) external onlyOwner {
      ...
      _allowances[address(this)][address(_poolAddress)] = _totalSupply;
    }
    ...
    function swapBack() internal swapping {
        ...
        TransferHelper.safeApprove(address(this), address(nonfungiblePositionManager), amountToLiquify);
        TransferHelper.safeApprove(WBNB, address(nonfungiblePositionManager), amountBNBLiquidity);   
