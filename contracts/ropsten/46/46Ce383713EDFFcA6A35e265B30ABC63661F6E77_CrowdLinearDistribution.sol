...
contract CrowdLinearDistribution is Ownable {
    ...
    function create(address beneficiary, uint256 start, uint256 cliff, uint256 initialShare, uint256 periodicShare, uint256 vestingType, uint256 factor, uint256 balance) onlyOwner external {
        ...
        require(initialShare >= 0, "CrowdLinearDistribution: initialShare must be equal or greater than zero");
        require(initialShare <= balance, "CrowdLinearDistribution: initialShare must be equal or less than balance");
        require(periodicShare >= 0, "CrowdLinearDistribution: periodicShare must be equal or greater than zero");
        ...
        require(factor >= 0, "CrowdLinearDistribution: factor must be equal or greater than zero");
        require(start >= block.timestamp, "CrowdLinearDistribution: start must be equal or greater than current time");
        require(cliff >= start, "CrowdLinearDistribution: start must be equal or greater than start");
