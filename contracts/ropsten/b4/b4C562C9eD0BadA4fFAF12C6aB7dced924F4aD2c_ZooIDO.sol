...
contract ZooIDO is Ownable 
{
	...
	uint256 public firstPhaseDuration = 30 minutes;//5 days;                                 // Duration of whitelist buy phase.
	uint256 public secondPhaseDuration = 30 minutes;//3 days;                               // Duration of non whitelist buy phase.
	uint256 public thirdPhaseDuration = 30 minutes;//17 days;                                // Duration of zoo tokens lock from start of ido.
