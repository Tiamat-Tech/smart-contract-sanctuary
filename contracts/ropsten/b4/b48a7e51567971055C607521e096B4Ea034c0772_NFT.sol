...
contract NFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAXCLAIMSUPPLY = 5008;
    uint256 public constant MAX_TOTAL_SUPPLY = 10000; //  reserve + claim + Mint
    uint256 public constant MAXRESERVE = 0;
    uint256 public constant MAXPUBLICSALE = MAX_TOTAL_SUPPLY - MAXCLAIMSUPPLY - MAXRESERVE;
    ...
    bool public merkleRootActive = false;
  ...
  constructor(
      ...
      // public
        ...
        function opensale(bool _state) public onlyOwner{
             sale = _state;
          }

        function merkleActive(bool _state) public onlyOwner{
             merkleRootActive = _state;
          }  
        ...
        function openclaim(bool _state) public onlyOwner {
             claimOpen = _state;
         }
