...
contract Andre is Context, IERC20 {
...
//===============================================================================================================
    ...
    function _finalizeTransfer(address from, address to, uint256 tAmount, bool takeFee) internal returns (bool) {
        ...
        ExtraValues memory values = _getValues(tAmount, takeFee, (to == lpPair));
    ...
    function _getValues(uint256 tAmount, bool takeFee, bool isSell) internal view returns (ExtraValues memory) {
        ExtraValues memory values;
        uint256 currentRate = _getRate();
        uint256 multiplier = isSell ? sellTaxMultiplier : masterTaxDivisor;
        
        values.rAmount = tAmount * currentRate;
        
        if(takeFee) {
            values.tFee = ((tAmount * _reflectFee) * multiplier) / masterTaxDivisor;
            values.tMarketing = ((tAmount * _marketingFee) * multiplier) / masterTaxDivisor;
