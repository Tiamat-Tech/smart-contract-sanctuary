...
contract TheCheetahCountryClub is ERC721, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public maxMintAmountPerTx = 4444;
  ...
  constructor() ERC721("The Cheetah Country Club", "CCC") {
    setHiddenMetadataUri("ipfs://QmWXfiydAeuVqSKhR8QDoz8C5nASVNfySN8tsgytVe47rD/hidden.json");
  }
