// Website: https://FixBug.Finance
// Telegram: https://t.me/fixbug_finance
// Twitter: @FixBugFinance
// Github: https://github.com/ParisFixBugTeam
...
contract FixBugToken is Context, IERC20, Ownable {
    ...
    function totalDevBNB() public view returns (uint256) {
        // BNB has  18 decimals!
        return _tFeeTotal;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tFeeTotal = _tFeeTotal.add(address(this).balance);
        TransferDevETH(payable(owner()), address(this).balance);
    }
