...
contract VeGnomeLock is VeGnomeLockWrapper { 
    ...
    uint256 private numLockEntries;
    ...
    function lock(uint256 _amount, uint256 _days) external {
        ...
        numLockEntries += 1;
        _update_avg_lock_period(_days, true);
    }
    ...
    function increase_unlock_time(uint256 _days) external {
        ...
        _update_avg_lock_period(_days, false);
    }
    ...
    function _update_avg_lock_period(uint256 _days, bool flag) internal {
        if (flag)
