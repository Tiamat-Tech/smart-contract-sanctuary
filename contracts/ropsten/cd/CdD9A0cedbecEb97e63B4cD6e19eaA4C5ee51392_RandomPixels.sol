...
contract RandomPixels is ERC721, ERC721Enumerable, Ownable {
        ...
        returns (string memory)
    {
        ...
        string memory hexChars = _toHexString(notSoRandom % divisor, 6);
    ...
    function drawSvg(uint256 tokenId) private view returns (string memory) {
