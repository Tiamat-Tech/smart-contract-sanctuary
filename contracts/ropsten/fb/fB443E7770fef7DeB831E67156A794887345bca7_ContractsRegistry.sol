...
contract ContractsRegistry is IContractsRegistry, AccessControlUpgradeable {
    ...
    bytes32 public constant BMI_STAKING_NAME = keccak256("BMI_STAKING_NAME");
    ...
    bytes32 public constant LIQUIDITY_MINING_NFT_NAME = keccak256("LIQ_MINING_NFT");
    ...
    function upgradeContract(bytes32 name, address newImplementation) external onlyAdmin {
        ...
        require(
            _isProxy[contractToUpgrade],
            "ContractsRegistry: Can't upgrade not a proxy contract"
        );
