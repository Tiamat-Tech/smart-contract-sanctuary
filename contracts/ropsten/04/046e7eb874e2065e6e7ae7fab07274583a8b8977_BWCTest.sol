...
contract BWCTest is ERC721, Ownable {
	...
	uint constant basePrice = 50000000000000000; // 0.05 ETH
	
	uint public bwcPrice = 50000000000000000; // 0.05 ETH
	uint public preSalePrice = 40000000000000000; // 0.04 ETH	
    ...
    constructor(string memory initBaseURI, string memory initNotRevealedUri, address pm, address dev) ERC721("BWCTest", "BWCT") {
