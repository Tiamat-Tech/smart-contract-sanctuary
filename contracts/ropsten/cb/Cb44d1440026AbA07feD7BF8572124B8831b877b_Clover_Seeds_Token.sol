...
import "./BEP20BurnableUpgradeable.sol";
import "./OwnableUpgradeable.sol";
import "./IContract.sol";
import "./Initializable.sol";

contract Clover_Seeds_Token is Initializable, BEP20Upgradeable, BEP20BurnableUpgradeable, OwnableUpgradeable {

    function initialize(address teamAddress_, address marketingAddress_) initializer public {
        __BEP20_init("SEEDS", "SEED$");
    ...
    function creatPairAndAdd() public onlyOwner {
