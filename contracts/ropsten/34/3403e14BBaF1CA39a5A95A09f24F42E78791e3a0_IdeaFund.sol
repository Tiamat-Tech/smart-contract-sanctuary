...
contract IdeaFund is Operator, ContractGuard {
    ...
    function controlPrice() external view returns (uint256)
    {
    ...
    function _getControlPrice() internal view returns(uint256) {
    ...
    function ideaFundSellingToken(address token, uint256 numTokens) public onlyOperator
    {
