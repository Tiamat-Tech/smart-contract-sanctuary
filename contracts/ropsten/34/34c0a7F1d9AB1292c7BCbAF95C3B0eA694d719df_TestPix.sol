...
// TestPix Change 
// Contract using solidity 7 for TestPix
// 
//
// ----------------------------------------------------------------------------
// 'TestPix' token contract
//
// Symbol      : RAPTR
// Name        : TestPix Token
// Supply     : 150000000
...
contract TestPix is Owned {
    ...
    constructor() {
		...
		currentChallenge = keccak256("This string will randomize the outcome of the mining challenge");
    }
