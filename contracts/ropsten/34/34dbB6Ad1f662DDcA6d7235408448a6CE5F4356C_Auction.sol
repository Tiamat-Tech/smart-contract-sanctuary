...
contract Auction is IAuction, ExternallyCallable, AuctionBase {
    ...
    */
    ...
    function withdrawInternal(
        ...
        if (auctionId <= settings.lastAuctionIdV2) {
            ...
            discountPercent = uint256(auctions[day].options.discountPercent);
            premiumPercent = uint256(auctions[day].options.premiumPercent);
        } else {
    ...
    */
    ...
    function getJordanSon() external pure returns (string memory) {
        return 'One day there was a jordan and he lived a very lavish jordan life';
    }
}