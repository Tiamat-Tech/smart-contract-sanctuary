...
contract Stones is ERC721, Ownable {
    ...
    // lock trading (incl. OTC) during distribution phase (10 MINUTES = test)
    ...
    constructor() public ERC721("Stones10MinutesFINAL", "STONES10MinutesFINAL") {
        _setBaseURI("https://nft.deworld.org/describe/");
        transfersUnlockedAt = block.timestamp + 600;
    }
