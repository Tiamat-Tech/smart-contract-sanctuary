...
contract AlphaB is Context, IBEP20, Ownable {
    ...
    string private _name = "AlphaB";
    string private _symbol = "ALPHAB";
    ...
    uint256 public _marketigFee = 3;
    uint256 private _previousMarketingFee = _marketigFee;
    ...
    address payable private marketingWallet = 0xAcC5d485DEBC3a9860d9Fce8Dc72BE97bD313c3D;
    ...
    function calculateMarketingFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_marketigFee).div(
            10**2
        );
    }

    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _marketigFee == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousLiquidityFee = _liquidityFee;
        _previousMarketingFee = _marketigFee;
    ...
    function restoreAllFee() private {
        ...
        _marketigFee = _previousMarketingFee;
