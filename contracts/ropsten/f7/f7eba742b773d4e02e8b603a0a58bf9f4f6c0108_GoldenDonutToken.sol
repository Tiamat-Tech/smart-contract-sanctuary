...
contract GoldenDonutToken is IBEP20, Ownable {
    ...
    uint256 immutable public _buyFeeTokenDistribution = 3;
    uint256 immutable public _buyFeeLiquid = 2;
    uint256 immutable public _buyFeeMarketing = 3;
    uint256 immutable public _buyFeeBNBDistribution = 5;

    uint256 immutable public _sellFeeBNBDistribution = 5;
    uint256 immutable public _sellFeeLiquid = 2;
    uint256 immutable public _sellFeeBurn = 3;
