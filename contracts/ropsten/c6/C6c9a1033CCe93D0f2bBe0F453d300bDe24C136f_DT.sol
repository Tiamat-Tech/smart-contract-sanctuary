...
contract DT is Context, Ownable, IERC20, LockableSwap, BuyBackToken, EthReflectingToken {
...
//        }
    ...
    function swapEthBasedFees(uint256 reflections, uint256 buyback) private returns(uint256 ethForReflections, uint256 ethForBuyback){
        ...
        // swap tokens for ETH
        swapTokensForEth(reflections.add(buyback)); // <- this breaks the ETH ->  swap when swap+liquify is triggered
