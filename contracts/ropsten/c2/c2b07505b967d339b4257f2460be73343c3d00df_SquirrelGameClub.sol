...
// File: contracts/SQGC.sol

//SPDX-License-Identifier: Unlicense

// @title: Squirrel Game Club
// @author: Squirrel Game Club Team

//  _____             _               _   _____                        _____ _       _     
// /  ___|           (_)             | | |  __ \                      /  __ \ |     | |    
// \ `--.  __ _ _   _ _ _ __ _ __ ___| | | |  \/ __ _ _ __ ___   ___  | /  \/ |_   _| |__  
//  `--. \/ _` | | | | | '__| '__/ _ \ | | | __ / _` | '_ ` _ \ / _ \ | |   | | | | | '_ \ 
// /\__/ / (_| | |_| | | |  | | |  __/ | | |_\ \ (_| | | | | | |  __/ | \__/\ | |_| | |_) |
// \____/ \__, |\__,_|_|_|  |_|  \___|_|  \____/\__,_|_| |_| |_|\___|  \____/_|\__,_|_.__/ 
//           | |                                                                           
//           |_|                                                                                                                     
...
contract SquirrelGameClub is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public constant PRESALE_PRICE = 5E16; // 0.05 ETH
    uint256 public constant PRICE = 1E15; // 0.1 ETH
    ...
    address public constant creatorAddress = 0x9C0F3594A55796cf550e801Bd87d754752f0Df6b;
    string public baseTokenURI;

    event CreateSquirrel(uint256 indexed id);
    event AttributeChanged(uint256 indexed _tokenId, string _key, string _value);

    constructor(string memory baseURI) ERC721("SQUIRREL GAME CLUB", "SQGC") {
        setBaseURI(baseURI);
        pause(true);
        presale = false;
        sale = false;
    ...
    function presaleMint(address _to, uint256 _count) public payable saleIsOpen {
        ...
        require(msg.value >= PRESALE_PRICE.mul(_count), "Value below price");
