...
contract SOHO is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "SOHOTest1";
    string private _symbol = "SOHO";
    ...
    uint256 public time_delta;
    uint256 public _maxBalancePrct = 10; //10%
    uint256 public _maxTotalSupplyPrct = 1; // 1/1000 = 0.1%
    ...
    function ensureAntiWhale(
        ...
        if (
            ...
            require(amount <= tSupply.mul(_maxTotalSupplyPrct).div(1000), "Sent too high % of total supply");
    ...
    function ensureTimeLock(
        ...
        require(lastTransfer[from].add(time_delta) <= block.timestamp || _isExcludedFromTimelock[from] == true, "Max tx per hour reached");
