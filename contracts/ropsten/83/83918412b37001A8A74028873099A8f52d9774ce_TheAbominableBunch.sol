...
contract TheAbominableBunch is IERC721, IERC2981, ERC721Enumerable, EIP712Whitelisting, ReentrancyGuard {
    ...
    function purchase(uint256 _max, bytes calldata _signature, uint256 _mintAmount) 
        external 
        payable 
        nonReentrant 
    {
    ...
    function _mint(uint256 _quantity, uint256 price) internal {
