...
// main contract []
contract ERC_020837 is Context, IERC20, Ownable, ReentrancyGuard {
    // public properties
        // extend
    ...
    // private properties
        // tokenomics
            string private _name = "ERC_020837";
            string private _symbol = "ERC020837";
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC_020837: decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC_020837: transfer amount exceeds allowance"));
        return(true);
    }
    ...
    // setter
        function activateContract() external onlyOwner{
            require(!_initialLiquidity, "ERC_020837: Initial liquidity already set, cant active again!");
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC_020837: approve from the zero address");
        require(spender != address(0), "ERC_020837: approve to the zero address");
