...
contract SosWeb3 is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getFirstDapp(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "FIRSTDAPPS", firstdapps);
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Web3 #',
                        toString(tokenId),
                        '", "description": "NO public SALE! NO private SALE! NO VCS! Just Web3!", "image": "data:image/svg+xml;base64,',
    ...
    constructor() ERC721("Sos for Web3", "Web3") Ownable() {}
}
