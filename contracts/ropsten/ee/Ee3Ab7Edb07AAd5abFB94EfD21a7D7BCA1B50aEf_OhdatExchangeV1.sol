...
contract OhdatExchangeV1 is AccessControl, Pausable {
    ...
    event PurchaseSuccessful(address indexed buyer,uint256 indexed amount,uint256[]  nftTokenIds,uint256 indexed totalPrice);
    ...
    function purchase(uint256 _amount) public payable whenNotPaused {
        ...
        require(msg.value >= totalPrice,"You send the ether isn't enough!");
