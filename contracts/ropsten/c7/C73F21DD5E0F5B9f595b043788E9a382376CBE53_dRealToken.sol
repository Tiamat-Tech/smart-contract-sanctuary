...
contract dRealToken is ERC20 {
    ...
    address PRICE_CONSUMER = 0xd9145CCE52D386f254917e481eB44e9943F39138; //0xF6D9f3695F0CCF7cF745fE357C4B0F9DBBE37841; //Mainnet: 0x0529104EC7c2e21f0970f6Aa76AAd902C9ADD789
    ...
    function buyFromIco(uint256 _tokenAmount) public payable {
        ...
        ERC20(this).transfer(msg.sender, _tokenAmount); 
