...
interface IStrategy {
    ...
    function balanceOfPool() external returns (uint256);
 ...
 */
contract BorgVaultV1 is ERC20, Ownable, ReentrancyGuard {
     ...
     */
    function getPricePerFullShare() public returns (uint256) {
