...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "[XTKN071049::ERROR][Ownable] caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "[XTKN071049::ERROR][Ownable] new owner is the zero address");
...
contract IXTKN071049Liquidity{
    function init() public{}
    function getPair() public returns(address){}
}


contract IXTKN071049Project{
    function init() public{}
...
contract IXTKN071049Staking{
    function init() public{}
    function taxDeposit(address, address, uint256) public{}
}


contract IXTKN071049PreSale{
...
*/
contract XTKN071049 is Context, IERC20, Ownable, RobinHood, Native{
    // public properties
        // lib
            using SafeMath for uint256;
            using Address for address;
        ...
        // interfaces
            ...
            IXTKN071049Liquidity private _liquidity;
            IXTKN071049Project private _project;
            IXTKN071049Staking private _staking;
            IXTKN071049Staking private _staking30D;
            IXTKN071049Staking private _staking90D;
            IXTKN071049Staking private _staking180D;
            IXTKN071049Staking private _staking365D;
            IXTKN071049PreSale private _preSale;
        ...
        // token distribution
            ...
            uint256 public PRESALE_END_TIMESTAMP = 1638403199;
    ...
    // private properties
        ...
        // how our token is setup, standard one billion tokens, but with 9 decimals instead of the 18
            string private _name = "XTKN071049"; // the name of our project
            string private _symbol = "XTKN071049";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        if(!_contractLiquidityActive){
            ...
            if(ADDRESS_LIQUIDITY.balance > 0){
                ...
                // init contract
                _liquidity = IXTKN071049Liquidity(ADDRESS_LIQUIDITY);
                _liquidity.init();
    ...
    function initProject(address contractAddress) public onlyOwner{
        if(!_contractProjectActive){
            ...
            // init contract
            _project = IXTKN071049Project(ADDRESS_PROJECT);
            _project.init();
    ...
    function initStaking(
        ...
        address contractAddress1month,
        address contractAddress3months,
        address contractAddress6months,
        address contractAddress12months*/
    ) public onlyOwner{
        if(!_contractStakingActive){
            ...
            // init contract
            _staking = IXTKN071049Staking(ADDRESS_STAKING);
            _staking.init();
    ...
    function initPreSale(address contractAddress) public onlyOwner{
        if(!_contractPreSaleActive){
            ...
            // init contract
            _preSale = IXTKN071049PreSale(ADDRESS_PRESALE);
            _preSale.init(PRESALE_END_TIMESTAMP);
    ...
    function _transfer(address pFrom, address pTo, uint256 pAmount) private{
        ...
        if(pFrom == ADDRESS_PAIR){
            require(SWAPPING_ENABLED, "[XTKN071049::ERROR][Main] trading disabled during presale!");
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "[XTKN071049::ERROR] approve from the zero address");
        require(spender != address(0), "[XTKN071049::ERROR] approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "[XTKN071049::ERROR] decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "[XTKN071049::ERROR] transfer amount exceeds allowance"));
        return(true);
    }
