...
contract Banana is ERC721Enumerable, Ownable {
    ...
    function process_mint(uint256[] memory requestIds, uint256[] memory pubkeys1, uint256[] memory pubkeys2, uint256[] memory s, uint256[2] memory e) payable public saleIsOpen {
