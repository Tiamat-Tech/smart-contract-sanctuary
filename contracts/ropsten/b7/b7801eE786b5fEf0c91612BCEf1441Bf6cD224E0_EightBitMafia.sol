...
contract EightBitMafia is ERC721Enumerable, Ownable {
    ...
    function initialMint(uint256 startIndex, uint256 endIndex)
        public
        onlyOwner
    {
        require(endIndex <= 70, "Only the first 70 are for airdrops and such"); //
    ...
    function burn(uint256 tokenId) public virtual {
        require(
            contractBurned,
            "Cannot burn NFTs while minting is still available"
        );
