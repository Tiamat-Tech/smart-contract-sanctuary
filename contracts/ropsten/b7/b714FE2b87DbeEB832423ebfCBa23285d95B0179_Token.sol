...
contract Token is ERC721, Ownable {
    ...
    event prizeShouldPay(uint256 value);
    ...
    function playerMint(
        ...
        _safeMint(msg.sender, nextId);
        uint256 prize =(msg.value).div(10); // 10% of mint price
        emit prizeShouldPay(prize);
        payable(address(arena)).transfer(prize); //10% of mint price sent at prize
