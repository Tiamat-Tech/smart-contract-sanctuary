...
contract ERC777Upgradeable is Initializable, ContextUpgradeable, IERC777Upgradeable, IERC20Upgradeable,Pausable {
    ...
    function send(
        ...
        uint256 amount,
        bytes memory data
    ) public virtual whenNotPaused override {
     ...
     */
    function approve(address spender, uint256 value) public virtual whenNotPaused override returns (bool) {
