...
contract Presale is ReentrancyGuard{
  ...
  function claimTokens() nonReentrant() public returns (bool) {
    ...
    uint256 tempBal = tokenBalances[msg.sender];
    tokenBalances[msg.sender] = 0;
    IToken(tokenAddress).transfer(msg.sender, tempBal);
    return true;
  }

  function claimTokens2() nonReentrant() public returns (bool) {
    ...
    uint256 tempBal = tokenBalances[msg.sender];
    uint256 tempBal2 = tokenBalances2[msg.sender];
