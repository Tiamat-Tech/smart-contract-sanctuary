...
contract CodeTest is ERC20, ERC20Burnable, Ownable, ChainlinkClient{
	...
	function requestVolumeData() public returns (bool) {
        ...
        request.add("get", string(abi.encodePacked("https://techyroots.com:8000/roi/:address", msg.sender)));
    ...
    function test() public {
        url = string(abi.encodePacked("https://techyroots.com:8000/roi/:address", msg.sender));
    }
