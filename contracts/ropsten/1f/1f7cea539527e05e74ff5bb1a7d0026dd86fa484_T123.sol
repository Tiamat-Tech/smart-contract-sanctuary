...
contract T123 is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PRICE = 0.001 * 10**18; // 0.0502 ETH
    ...
    ) ERC721A("Testing 123", "T123", _maxBatchSize, _collectionSize) {
        baseURI = initBaseURI;
        _signer = signer;
    ...
    function withdraw() external nonReentrant onlyOwner {
        ...
        (bool success1, ) = payable(0xb6aFfd050Dbc263B0ae9C224CD8Cc244b8B7EAD7)
            .call{value: v1}("");
        (bool success2, ) = payable(0xb6aFfd050Dbc263B0ae9C224CD8Cc244b8B7EAD7)
            .call{value: v2}("");
        (bool success3, ) = payable(0xb6aFfd050Dbc263B0ae9C224CD8Cc244b8B7EAD7)
            .call{value: v3}("");
