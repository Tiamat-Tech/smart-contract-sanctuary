...
//    mapping(FeeLibrary.FeeLevels => FeeLibrary.SellFees) public sellFees;
//    mapping(FeeLibrary.FeeLevels => FeeLibrary.SellFees) private previousSellFees;
...
//    FeeLibrary.FeeLevels private FeeLevels = FeeLibrary.FeeLevels;
...
//        }
    ...
    function removeAllFee() private {
        ...
        previousSellFees.setFrom(sellFees); //[FeeLevels.LEVEL1] = sellFees[FeeLevels.LEVEL1];
...
//        previousSellFees[FeeLevels.LEVEL5] = sellFees[FeeLevels.LEVEL5];
        ...
        buyFees.setToZero(); // = Fees(0, 0, 0, 0, 0, 0);
        transferFees.setToZero(); // = Fees(0, 0, 0, 0, 0, 0);
        sellFees.setToZero(); //[FeeLevels.LEVEL1] = SellFees(0, 0, 0, 0);
...
//        sellFees[FeeLevels.LEVEL5] = SellFees(0, 0, 0, 0);
    ...
    function restoreAllFee() private {
        ...
        sellFees.setFrom(previousSellFees); // [FeeLevels.LEVEL1] = previousSellFees[FeeLevels.LEVEL1];
...
//        buyFees.reflection = reflectionFee;
//        buyFees.project = projectFee;
//        buyFees.liquidity = liquidityFee;
//        buyFees.burn = burnFee;
//        buyFees.marketing = marketingFee;
//        ethRbuyFees.eflection = ethReflectionFee;
