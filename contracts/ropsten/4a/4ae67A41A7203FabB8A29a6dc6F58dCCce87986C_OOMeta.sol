...
// This Contract is opensource from OOMeta and for learning test, don't use it to do other thing..
contract OOMeta is ERC721, Ownable {
    ...
    function getOOMetaByOwner(address _owner)
        public
        view
    ...
    function mintOOMeta(
        ...
        require(_isSaleActive, "Sale must be active to mint OOMetas");
        require(
        ...
        _mintOOMeta(tokenQuantity, msg.sender);
        emit TokenMinted(totalSupply);
        _usedNonces[nonce] = true;
    }

    function auctionMintOOMeta(
        bytes32 hash,
        bytes memory signature,
        string memory nonce,
        uint256 tokenQuantity
        ...
        require(_isAuctionActive, "Auction must be active to mint OOMetas");
    ...
    function whiteListMintOOMetas(uint256 tokenQuantity) public payable {
        require(_isWhiteListSaleActive, "Sale must be active to mint OOMetas");
    ...
    function _mintOOMeta(uint256 tokenQuantity, address recipient) internal {
