...
contract GHCBridge is Ownable {
    ...
    address payable public admin;                       // Admin account with access to funds in the vault
    ...
    function depositFrom(address from, uint256 amount) public payable {
        ...
        require(success, "Forwading of ETH failed.");
