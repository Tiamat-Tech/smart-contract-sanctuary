...
contract HotCactusClub is ERC721 {



uint HotCactusClubPrice = 50000000000000000; // 0.05 ETH


uint MAX_HCC = 10000; //Max supply

 
// Reserve for team - Giveaways/Prizes etc
uint HotCactusClubReserve = 250;  //Reserve for marketing purpose


//Number max of HotCactusClub that someone can purchase at once
uint maxHotCactusClubPurchase = 30;
...
uint mintIndex; //0 by default
string bURI = "https://hotcactusclub.com/metadata/";

constructor() ERC721("Hot Cactus Club", "HCC") { 
...
// Mint special ones
  ...
  function mintSpecial(address to, uint id) external {
...
//User/Customer Mint
    ...
    function mintHotCactusClub(uint numberOfTokens) public payable {
...
function reserveSome(address _to, uint _reserveAmount) external {
        require(msg.sender == owner);
...
//override openzeppelin ERC721 baseURI function
...
/*pas besoin de cette fonction, suffit de mettre totalSupply en public*/
